...
# 个人信息
 ...
 - 本科/广州大学计算机系 
 - 工作年限：7年
 - 技术博客：http://my.oschina.net/benhaile/blog
...
### 团队协作平台（team.oschina.net) 
2014年加入开源中国作为该产品的技术Leader，从前期的架构到产品开发结束每个环节都参与。
...
### 运价魔方-垂直爬虫引擎 (http://cube.foreveross.com/system/start/index.action)
我在此项目负责了爬虫引擎的主程序开发，爬虫引擎，这个项目中，我最困难的问题是什么，我采取了什么措施，最后结果如何。这个项目中，最自豪的技术细节是防屏蔽以及大数据存储，为什么，实施前和实施后的数据对比如何，同事和领导对此的反应如何。
